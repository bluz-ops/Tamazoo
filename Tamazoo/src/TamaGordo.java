 ...
 * @author Daian
 *
 * Il TamaGordo è una specie di Tamagotchi caratterzzata dall'indifferenza nei confronti del lato
...
public class TamaGordo extends Tamagotchi {
	...
	public TamaGordo(String _nome, int _affetto, int _sazieta) {
    ...
    public void riceviCarezze (int carezze) {
        sazieta = Math.max(SAZIETA_MIN, sazieta - 2*carezze/ FATTORE_CAREZZE);
    }
